...
# DATE CREATED: 15:42 PM 12/15/2020                                
# REVISED DATE: 
...
def classify_images(images_dir, results_dic, model):
    ...
    # that indicates the folder and the key to be used in the classifier function
    ...
    for key in results_dic:
       ...
       model_name = classifier(images_dir+key, model)
       ...
       if truth in model_name:
           results_dic[[key][0]].extend([model_name, 1])
       ...
       # the extend function 
           ...
           results_dic[[key][0]].extend([model_name, 0])
    print(results_dic)
